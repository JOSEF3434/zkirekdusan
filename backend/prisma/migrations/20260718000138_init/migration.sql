...
-- CreateEnum
CREATE TYPE "FileProvider" AS ENUM ('LOCAL', 'S3', 'CLOUDINARY', 'MINIO');
...
-- AddForeignKey
ALTER TABLE "profiles" ADD CONSTRAINT "profiles_coverFileId_fkey" FOREIGN KEY ("coverFileId") REFERENCES "files"("id") ON DELETE SET NULL ON UPDATE CASCADE;
