...
export class AdminDashboardService {
  ...
  async getMetrics() {
    const [
      ...
      this.prisma.group.count({ where: { status: 'PENDING_APPROVAL', deletedAt: null } }),
    ...
    return {
      ...
      groups: { total: totalGroups, pending: pendingGroups },
      channels: { total: totalChannels },
      content: { videos: totalVideos, posts: totalPosts },
