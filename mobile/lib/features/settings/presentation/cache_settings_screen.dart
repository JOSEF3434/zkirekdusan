        ...
        const SnackBar(
          content: Row(
            children: [
              ...
              SizedBox(width: 8),
              Text('App cache cleared successfully!'),
            ],
          ),
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          _CacheSummaryCard(state: s, isDark: isDark),
          ...
          SizedBox(
            ...
            child: ElevatedButton.icon(
              ...
              label: Text(
                _isClearing
                    ? 'Clearing Cache...'
                    : 'Clear All Cache (${_fmtMB(s.totalCacheMB)})',
          ...
          Center(
            child: Text(
              'Clearing cache won\'t delete your downloads or messages',
...
class _CacheSummaryCard extends StatelessWidget {
  ...
  const _CacheSummaryCard({required this.state, required this.isDark});
  ...
  Widget build(BuildContext context) {
    ...
    final segments = [
      (state.videoCacheMB, const Color(0xFF00C6FF), 'Video'),
      (state.imageCacheMB, const Color(0xFF43E97B), 'Images'),
      (state.audioCacheMB, const Color(0xFFFF9F43), 'Audio'),
      (state.databaseMB, const Color(0xFF6C63FF), 'Data'),
    ];
