...
_ChannelPlaylistItemDto _$ChannelPlaylistItemDtoFromJson(
...
Map<String, dynamic> _$ChannelPlaylistItemDtoToJson(
  _ChannelPlaylistItemDto instance,
) => <String, dynamic>{
  'id': instance.id,
...
_ChannelPlaylistDto _$ChannelPlaylistDtoFromJson(Map<String, dynamic> json) =>
    _ChannelPlaylistDto(
      id: json['id'] as String,
      ...
      items:
          (json['items'] as List<dynamic>?)
              ?.map(
                (e) =>
                    ChannelPlaylistItemDto.fromJson(e as Map<String, dynamic>),
              )
              .toList() ??
          const [],
...
Map<String, dynamic> _$ChannelPlaylistDtoToJson(_ChannelPlaylistDto instance) =>
    <String, dynamic>{
      'id': instance.id,
